class GroupFormsController < ApplicationController
  ...
  def download_report
    @application = GroupForm.find(params[:id])
    ...
    @application.participants.each_with_index do |participant, index|
    ...
    send_data pdf.render,
              filename: "fiche_group_#{@application.name.parameterize}.pdf",
