class IndividualForm < ApplicationRecord
  ...
  validates :level, presence: true, inclusion: { in: ['Préparatoire', 'Elémentaire 1', 'Elémentaire 2', 'Elémentaire 2 - Répertoire', 'Moyen', 'Moyen - Répertoire', 'Avancée', 'Supérieur', 'Interprète'] }
